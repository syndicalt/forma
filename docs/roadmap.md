...
- Host read tool mapping through `tools.readText` and `tools.read_text`.
...
- Host runtime hooks for search, test, and edit actions.
...
3. Coding-agent tool mapping: add search, test, and edit host hooks.
