...
- Host read and search tool mapping through runtime tools.
...
- Host runtime hooks for test and edit actions.
...
3. Coding-agent tool mapping: add test and edit host hooks.
