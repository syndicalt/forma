...
const requiredTerms = {
  ...
  "docs/index.md": ["Migration Parity", "review_diff_inline", "proof:migration", "package-review examples/review_diff.forma.pkg.json --proof-command", "missingMigrationParityProofCommand"],
  "docs/language/diagnostics.md": [
    "F0001",
    "F1001",
    "F1002",
  ...
  "docs/guides/quickstart.md": ["corepack pnpm", "python -m pytest", "forma run", "package-review examples/review_diff.forma.pkg.json --proof-command", "missingMigrationParityProofCommand", "project-check --json"],
