...
const requiredTerms = {
  ...
  "docs/guides/runtime-results.md": ["ok", "output", "trace", "diagnostics", "verification", "guard between model output and host code", "Treat failed validation as a host integration bug until proven to be model behavior", "if (!result.ok)", "if not result.ok"],
