...
const requiredTerms = {
  ...
  "docs/packages/cli.md": ["forma check", "forma run", "forma preview", "preview --watch", "forma project-init", "forma project-check", "function-repair"],
  ...
  "docs/guides/package-consumer-quickstart.md": ["agentFromPackageLock", "agent_from_package_lock", "review_diff.forma.lock.json", "TypeScript", "Python"],
