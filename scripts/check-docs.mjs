...
const requiredTerms = {
  ...
  "docs/guides/why-forma.md": ["contract layer, not prompt storage", "reviewable agent capability", "agentFromPackageLock", "agent_from_package_lock", "do not use Forma", "The minimum useful contract boundary before packaging", "The reusable package is the adoption unit"],
  "docs/guides/package-consumer-quickstart.md": [
