...
const requiredTerms = {
  "README.md": ["Five-Minute Usefulness Path", "inline prompt plus local schemas", "before package-review or package locks", "Migration Parity", "review_diff_inline", "proof:migration", "projects:check", "proof:release", "examples/review-diff-agent", "review_diff_package_lock", "package-review examples/review_diff.forma.pkg.json --proof-command", "missingMigrationParityProofCommand", "Which Scaffold Should I Use?", "docs/guides/first-use-audit.md", "first-use audit", "generated project READMEs", "project-init --minimal", "default project-init", "project-init --package-lock", "local to one application", "checked in CI", "consuming a reviewed package"],
