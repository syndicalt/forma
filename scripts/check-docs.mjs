...
const requiredTerms = {
  ...
  "docs/packages/python.md": ["FormaRuntime", "StaticProvider", "Model-call execution and contract validation are separate responsibilities", "pip install forma-lang"],
  ...
  "docs/guides/package-consumer-quickstart.md": [
    ...
    "Cleaned-up route labels should preserve adoption-proof audit lookup keys",
    "Cleaned-up route labels should preserve release-adoption audit lookup keys",
    "Cleaned-up route labels should preserve release-proof audit lookup keys",
