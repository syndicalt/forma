...
const installedPackageSmokes = [
  ...
  },
  {
    ...
    expectedArtifacts: [
      ...
      {
        label: "function-repair trace tests and fixtures",
        files: ["repair_function_contract.test.ts", "repair_function_trace.test.ts", "repair_function_contract_test.py", "repair_function_trace_test.py", "fixtures/billing.ts", "fixtures/billing.test.ts", "fixtures/billing.py", "fixtures/test_billing.py"],
      },
      {
        label: "package README and release workflows",
        files: ["README.md", ".github/workflows/forma-package.yml", ".github/workflows/forma-publish.yml"],
    ...
    files: [
      ...
      "repair_function_contract.test.ts",
      "repair_function_trace.test.ts",
      "repair_function_contract_test.py",
      "repair_function_trace_test.py",
      "fixtures/billing.ts",
      "fixtures/billing.test.ts",
      "fixtures/billing.py",
      "fixtures/test_billing.py",
      "README.md",
      ".github/workflows/forma-package.yml",
      ".github/workflows/forma-publish.yml",
    ],
    prepare: prepareFunctionRepairSmoke,
    typeScriptCommand: ["corepack", ["pnpm", "exec", "vitest", "run", "repair_function_installed.test.ts", "repair_function_contract.test.ts", "repair_function_trace.test.ts"]],
    pythonCommand: ["-c", "import runpy; runpy.run_path('repair_function_installed_smoke.py', run_name='__main__'); runpy.run_path('repair_function_contract_test.py', run_name='__main__'); runpy.run_path('repair_function_trace_test.py', run_name='__main__')"],
  },
  {
